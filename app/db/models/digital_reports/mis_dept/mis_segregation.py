...
class DigitalReportsMisSegregation(Base):
    __tablename__ = "dr_mis_segregation"
    ...
    flt_origin: Mapped[Optional[str]] = mapped_column(String(10))
    flt_org_country: Mapped[Optional[str]] = mapped_column(String(100))
    flt_org_continents: Mapped[Optional[str]] = mapped_column(String(100))

    month_year: Mapped[Optional[str]] = mapped_column(String(20), index=True)
    ...
    awb_org_country:    Mapped[Optional[str]] = mapped_column(String(60), index=True)
    awb_org_continents: Mapped[Optional[str]] = mapped_column(String(30), index=True)
    ...
    def __repr__(self) -> str:
        return f"<DigitalReportsMisSegregation {self.carrier} {self.flt_no} {self.awb_no or 'NIL'} {self.flt_date}>"