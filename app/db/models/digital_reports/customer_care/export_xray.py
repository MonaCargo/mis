...
class DigitalReportExportXray(Base):
   
    
    __tablename__ = "dr_exp_xray"
    ...
    sb_no       = Column(String(50),  nullable=False, index=True) 
    sb_date     = Column(DateTime(timezone=True), nullable=False)
    ...
    car_msg_datetime = Column(DateTime(timezone=True), nullable=False) 
    ...
    xray_type           = Column(String(50),  nullable=False) 
    ...
    __table_args__ = (
        Index("ix_dr_exp_xray_month", "month_uploaded"),
        Index("ix_dr_exp_xray_awb_month", "awb_no", "month_uploaded"),
        Index("ix_dr_exp_xray_dedup", "awb_no", "xray_start_datetime"),
    )
