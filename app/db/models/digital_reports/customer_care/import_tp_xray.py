...
class DigitalReportImportTpXray(Base):
   
    
    __tablename__ = "dr_imp_tp_xray"
    ...
    month_uploaded  = Column(String(7),   nullable=False, index=False)
    ...
    __table_args__ = (
        Index("ix_dr_imp_tp_xray_month", "month_uploaded"),
        Index("ix_dr_imp_tp_xray_awb_month", "awb_no", "month_uploaded"),
        Index("ix_dr_imp_tp_xray_dedup", "awb_no", "xray_start_datetime"),
    )
