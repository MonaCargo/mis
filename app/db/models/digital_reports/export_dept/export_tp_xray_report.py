...
class DigitalReportExportTpXrayReport(Base):
    """
    Source: Export TP X-RAY Report sheet
    Combined with xray_report + import_tp_xray_report for dashboard Section P.3
    Shift-basis column: xray_date_time
    """
    __tablename__ = "dr_exp_export_tp_xray_report"
    ...
    doc_accept_date_time = Column(DateTime, nullable=True)
